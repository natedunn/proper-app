...
function generatePresets(zip) {
  var presets;
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function generatePresets$(_context2) {
    while (1) {
...
function generateManifests(queue, zip) {
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function generateManifests$(_context3) {
    while (1) {
...
function makeZip(zip) {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function makeZip$(_context4) {
    while (1) {
...
function generateZip(queue) {
  var zip;
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function generateZip$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(generateFolders());
...
//# sourceMappingURL=index.js.2f295db86f5bf08dbf5b.hot-update.js.map