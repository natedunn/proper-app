...
var _StyledH = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_heading__WEBPACK_IMPORTED_MODULE_13__["H2"]).withConfig({
  displayName: "queue___StyledH",
...
var _StyledButton = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_button__WEBPACK_IMPORTED_MODULE_12__["default"]).withConfig({
  ...
  componentId: "sc-4mxwog-4"
})({
  "display": "inline-flex",
  "alignItems": "center"
});

var _StyledSvg = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].svg.withConfig({
  displayName: "queue___StyledSvg",
  componentId: "sc-4mxwog-5"
})(function (p) {
  return {
    "fill": p._css6,
    "width": p._css7,
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Queue, [{
    ...
    value: function render() {
      ...
      if (items.length) return __jsx(_StyledDiv, {
        _css: _tailwindConfig.theme.margin["10"],
        __source: {
        ...
        _css2: _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(tailwind_macro_utils_umd_js__WEBPACK_IMPORTED_MODULE_7___default.a.resolveStyle(_tailwindConfig, [{
          "prop": "fontWeight",
          "config": "fontWeight"
        }, {
          "prop": "fontFamily",
        ...
        _css3: _tailwindConfig.theme.width["full"],
        _css4: _tailwindConfig.theme.margin["4"],
        __source: {
          fileName: _jsxFileName,
          lineNumber: 15
        },
        ...
        _css5: _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({
          "paddingTop": _tailwindConfig.theme.padding["6"],
          "paddingBottom": _tailwindConfig.theme.padding["6"],
          "paddingLeft": _tailwindConfig.theme.padding["8"],
          "paddingRight": _tailwindConfig.theme.padding["8"],
          "marginTop": _tailwindConfig.theme.margin["10"]
        ...
        }], "purple-100"), tailwind_macro_utils_umd_js__WEBPACK_IMPORTED_MODULE_7___default.a.resolveStyle(_tailwindConfig, [{
          "prop": "borderWidth",
          "config": "borderWidth"
        }, {
          "prop": "borderColor",
        ...
        viewBox: "0 0 20 20",
        _css6: _tailwindConfig.theme.fill["current"],
        _css7: _tailwindConfig.theme.width["4"],
        _css8: _tailwindConfig.theme.height["4"],
        _css9: _tailwindConfig.theme.margin["2"],
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        },
...
//# sourceMappingURL=index.js.b09031b0cd230fd8f52b.hot-update.js.map