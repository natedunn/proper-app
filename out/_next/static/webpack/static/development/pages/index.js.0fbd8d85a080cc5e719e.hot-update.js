...
var Version = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])('div').withConfig({
  displayName: "queueItem__Version",
  componentId: "sc-1gvu4xw-0"
})(["", ""], _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_5___default()({
...
var _StyledVersion = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(Version).withConfig({
  displayName: "queueItem___StyledVersion",
  componentId: "sc-1gvu4xw-1"
})(["", ""], function (p) {
  return p._css;
});
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(QueueItem, [{
    ...
    value: function render() {
      ...
      return __jsx("li", {
        className: "py-6 px-8 mt-2 flex items-center justify-between rounded border border-gray-400 bg-white",
        __source: {
        ...
        __self: this
      }, item.origin.name), __jsx(_StyledVersion, {
        _css: item.ver ? null : {
          "display": "none"
        },
        __source: {
...
//# sourceMappingURL=index.js.0fbd8d85a080cc5e719e.hot-update.js.map